...
correct.item()/len(test_data) # 98.32% correct
...
torch.save(model.state_dict(), 'saved_nns/first_tutorial_rnn-gru.pt')
...
model_reloaded.load_state_dict(torch.load('saved_nns/first_tutorial_rnn-gru.pt'))
